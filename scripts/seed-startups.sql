-- Seed script to insert sample startups
-- Run this in Supabase SQL Editor

-- First, let's get the founder profile ID
-- Replace 'YOUR_FOUNDER_USER_ID' with the actual user_id from your profiles table
-- You can find this by running: SELECT user_id FROM profiles WHERE role = 'founder' LIMIT 1;
