-- Simple seed script that creates startups without requiring a founder profile
-- Run this AFTER running the setup script

-- First, let's create a temporary founder profile that we'll update later
-- We'll use a placeholder user_id that you can update after creating a real user
...
-- This will be used for all startups
DO $$
DECLARE
