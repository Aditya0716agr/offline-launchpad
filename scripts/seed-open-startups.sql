-- Seed script for open setup - everyone can add startups
-- Run this AFTER running setup-open-supabase.sql
...
VALUES (
    ...
    'Sample Founder',
    'user', -- Everyone is a regular user
    NOW(),
    NOW()
...
BEGIN
    ...
    SELECT id INTO founder_profile_id FROM profiles WHERE role = 'user' LIMIT 1;
    
    -- Insert sample startups (all auto-approved)
