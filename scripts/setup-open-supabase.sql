-- Open database setup - everyone can add startups and complete profiles
-- Run this in your new Supabase project's SQL Editor

-- Create user roles enum (simplified)
...
CREATE TABLE public.startups (
    ...
    email_contact TEXT,
    phone_number TEXT,
    status startup_status NOT NULL DEFAULT 'approved', -- Auto-approve all startups
    tagline TEXT,
    stage TEXT,
    team_size TEXT,
    launch_date DATE,
...
-- OPEN RLS Policies for profiles (everyone can view, users can manage their own)
...
-- OPEN RLS Policies for categories (everyone can view)
...
-- OPEN RLS Policies for startups (everyone can view and add)
...
-- OPEN RLS Policies for votes (everyone can view, authenticated users can vote)
...
-- OPEN RLS Policies for comments (everyone can view, authenticated users can comment)
...
-- OPEN RLS Policies for bookmarks (users can manage their own)
...
-- Function to handle new user registration (simplified - no role restrictions)
...
-- Success message
SELECT 'Open database setup completed successfully! 🎉 Everyone can now add startups!' as message;
