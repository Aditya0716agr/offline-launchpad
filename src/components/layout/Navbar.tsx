      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link to="/launch-day" className="text-muted-foreground hover:text-foreground transition-colors">
              Launch Day
            </Link>
          </div>
            ...
            {user ? (
              <>
                {profile?.role === 'founder' && (
                  <Button asChild variant="outline" size="sm" className="btn-outline-primary">
                    <Link to="/submit">
